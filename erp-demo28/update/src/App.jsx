...
const ALL_SUBS = [...DASH_SUBS, ...HR_SUBS, ...SESSION_SUBS, ...ENQUIRY_SUBS];
...
export default function App() {
  ...
  const [openMods,  setOpenMods]  = useState({ dashboard: false, hr: false, session: false, enquiry: false });
  ...
  const clickSub = (modId, sub) => {
    ...
    closeSidebar(); /* always close sidebar after selecting a page */
  };
  ...
  /* ── CONTENT RENDERER ── */
  const renderContent = () => {
    /* Default Dashboard page — show HomeDashboard with KPI, Graphs, Attendance */
    if (!activeMod) {
      return (
        <div>
